...
import com.example.haberler.ui.general.GeneralFragment;

import java.util.ArrayList;

public class SportFragment extends Fragment implements IPrepareRecyler, SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        GetNews getNews = new GetNews(SportFragment.this,"sport");
        getNews.execute();
