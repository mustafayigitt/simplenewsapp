...
public class EconomyFragment extends Fragment implements IPrepareRecyler, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        GetNews getNews = new GetNews(this,"economy");
        getNews.execute();
    ...
    public void onRefresh() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                GetNews getNews = new GetNews(EconomyFragment.this,"economy");
                getNews.execute();
            }
        }, 3000);
    }
